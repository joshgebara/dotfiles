...
# Set a desktop wallpaper to black
...
#Add Gitup
defaults write com.apple.dock persistent-apps -array-add '<dict><key>tile-data</key><dict><key>file-data</key><dict><key>_CFURLString</key><string>/Applications/GitUp.app</string><key>_CFURLStringType</key><integer>0</integer></dict></dict></dict>';
# Add Postman
...
tell application "Terminal"
    ...
    do shell script "open '../terminal_themes/" & themeName & ".terminal'"
...
for app in "TextEdit" "Messages" "Google Chrome" "Dock" "Finder"; do
